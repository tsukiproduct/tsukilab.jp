...
(() => {
  ...
  const presets = {
    ...
    caption: {bg:['#26262c','#0d0d10','#ffe14d'],font:'mplusr',anim:'word',layout:'center',viz:'off',accent:'#ffe14d',dim:35,blur:0,fx:90,grain:false,underline:false,zoom:true,shake:false,rgb:false,glitch:false,hold:0,note:'ショート字幕：歌詞が1ワードずつ弾んで入れ替わる。動きで「積み上げ」も選べます。'},
